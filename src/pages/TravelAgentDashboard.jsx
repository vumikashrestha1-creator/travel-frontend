...
const COUNTRY_CITIES = {
  ...
  "Chile":          ["Santiago", "Patagonia", "Valparaíso", "San Pedro de Atacama"],
  "China":          ["Beijing", "Shanghai", "Guangzhou", "Chengdu", "Xi'an"],
  "Colombia":       ["Bogota", "Cartagena", "Medellín", "Santa Marta"],
  ...
  "France":         ["Paris", "Lyon", "Nice", "Marseille", "Bordeaux", "Strasbourg"],
  "Germany":        ["Berlin", "Munich", "Hamburg", "Frankfurt", "Cologne"],
  "Greece":         ["Athens", "Santorini", "Mykonos", "Rhodes", "Crete", "Corfu"],
  "Hungary":        ["Budapest", "Debrecen", "Pécs"],
  "Iceland":        ["Reykjavik", "Akureyri", "Vik"],
  "India":          ["Mumbai", "Delhi", "Goa", "Jaipur", "Agra", "Varanasi", "Kerala", "Kolkata"],
  "Indonesia":      ["Bali", "Jakarta", "Lombok", "Yogyakarta", "Komodo", "Raja Ampat"],
  "Ireland":        ["Dublin", "Galway", "Cork", "Killarney"],
  "Israel":         ["Tel Aviv", "Jerusalem", "Haifa", "Eilat"],
  "Italy":          ["Rome", "Milan", "Venice", "Florence", "Naples", "Amalfi", "Sicily"],
  "Japan":          ["Tokyo", "Osaka", "Kyoto", "Hiroshima", "Sapporo", "Nara", "Fukuoka"],
  "Jordan":         ["Amman", "Petra", "Wadi Rum", "Aqaba"],
  "Kenya":          ["Nairobi", "Maasai Mara", "Mombasa", "Amboseli"],
  "Malaysia":       ["Kuala Lumpur", "Penang", "Langkawi", "Borneo"],
  "Maldives":       ["Male", "Maafushi", "Hulhumale", "Baa Atoll"],
  "Mexico":         ["Cancun", "Mexico City", "Tulum", "Playa del Carmen", "Oaxaca"],
  "Morocco":        ["Marrakech", "Casablanca", "Fez", "Chefchaouen"],
  "Nepal":          ["Kathmandu", "Pokhara", "Chitwan", "Lumbini", "Everest Base Camp"],
  "Netherlands":    ["Amsterdam", "Rotterdam", "The Hague", "Utrecht"],
  "New Zealand":    ["Queenstown", "Auckland", "Christchurch", "Wellington", "Rotorua"],
  "Norway":         ["Oslo", "Bergen", "Tromsø", "Flåm"],
  ...
  "South Africa":   ["Cape Town", "Johannesburg", "Kruger National Park", "Durban"],
  "South Korea":    ["Seoul", "Busan", "Jeju Island", "Gyeongju"],
  "Spain":          ["Barcelona", "Madrid", "Seville", "Valencia", "Ibiza", "Mallorca"],
  ...
  "Tanzania":       ["Dar es Salaam", "Zanzibar", "Serengeti", "Kilimanjaro"],
  "Thailand":       ["Bangkok", "Phuket", "Chiang Mai", "Koh Samui", "Pattaya", "Krabi"],
  "Turkey":         ["Istanbul", "Antalya", "Cappadocia", "Bodrum", "Pamukkale"],
  "UAE":            ["Dubai", "Abu Dhabi", "Sharjah", "Ras Al Khaimah"],
  "UK":             ["London", "Edinburgh", "Manchester", "Liverpool", "Oxford", "Bath"],
  "USA":            ["New York", "Los Angeles", "Las Vegas", "Miami", "Chicago", "San Francisco", "Hawaii", "Orlando"],
  "Vietnam":        ["Ho Chi Minh City", "Hanoi", "Ha Long Bay", "Hoi An", "Da Nang"],
};

const DESTINATIONS = [
  { group: "🌏 Asia",
    options: [
      "Bali, Indonesia", "Tokyo, Japan", "Bangkok, Thailand", "Singapore",
      "Kathmandu, Nepal", "Goa, India", "Colombo, Sri Lanka", "Phuket, Thailand",
      "Kyoto, Japan", "Osaka, Japan", "Kuala Lumpur, Malaysia", "Langkawi, Malaysia",
      "Ho Chi Minh City, Vietnam", "Ha Long Bay, Vietnam", "Siem Reap, Cambodia",
      "Boracay, Philippines", "Palawan, Philippines",
    ]},
  { group: "🌍 Middle East & Africa",
    options: [
      "Dubai, UAE", "Abu Dhabi, UAE", "Doha, Qatar", "Marrakech, Morocco",
      "Cairo, Egypt", "Zanzibar, Tanzania", "Cape Town, South Africa",
      "Maasai Mara, Kenya", "Petra, Jordan",
    ]},
  { group: "🌍 Europe",
    options: [
      "Paris, France", "Rome, Italy", "Barcelona, Spain", "London, UK",
      "Amsterdam, Netherlands", "Athens, Greece", "Santorini, Greece",
      "Istanbul, Turkey", "Venice, Italy", "Madrid, Spain", "Prague, Czech Republic",
      "Budapest, Hungary", "Dubrovnik, Croatia", "Lisbon, Portugal", "Reykjavik, Iceland",
    ]},
  { group: "🌎 Americas",
    options: [
      "New York, USA", "Los Angeles, USA", "Las Vegas, USA", "Miami, USA",
      "Cancun, Mexico", "Machu Picchu, Peru", "Rio de Janeiro, Brazil",
      "Buenos Aires, Argentina", "Cartagena, Colombia",
    ]},
  { group: "🌏 Pacific",
    options: [
      "Sydney, Australia", "Melbourne, Australia", "Brisbane, Australia", "Perth, Australia", "Adelaide, Australia", "Gold Coast, Australia", "Cairns, Australia",
      "Queenstown, New Zealand", "Auckland, New Zealand", "Nadi, Fiji",
